...
module.exports = {
    name: 'ai',
    description: 'An AI command powered by Neuronspike, modified by Alex Jhon Ponce',
    aliases: ['globalGPT'],
    cooldown: 3,
    nashPrefix: false,
    execute: async (api, event, args) => {
        ...
        if (!input) {
            api.sendMessage(
                `Hello there!\n\nI am an AI developed by Alex Jhon Ponce. I am here to assist you with any questions or tasks you may have.\n\nUsage: ai [your question]`,
                event.threadID,
                event.messageID
            );
            return;
        ...
        try {
            ...
            const finalResponse = `𖣘 𝗚𝗮𝗹𝗮𝘅𝘆 𝗕𝗢𝗧 シ︎\n\n${response}\n\nMAKE YOUR OWN BOT HERE\n`;
